...
<x-admin-nav>
<div class="container">
    <h1 class="glassmorphism-title">Add Work Experience</h1>
    <div class="glassmorphism-card mt-2 p-4">
        <div class="card-body">
            <form id="work-experience-form" role="form" action="{{ route('work-experience.store') }}" method="POST">
                @csrf
                <div class="controls">
                    <!-- Form Group Workplace -->
                    <div class="form-group">
                        <label for="workplace">Workplace *</label>
                        <input type="text" class="form-control" id="workplace" name="workplace" value="{{ old('workplace') }}">
                        @error('workplace')
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="duties" name="duties">{{ old('duties') }}</textarea>
                        @error('duties')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
