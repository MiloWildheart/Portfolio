...
<div class="row justify-content-center mt-3">
    <div class="col-md-8">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('Portfolio-items.store') }}" method="post">
                    @csrf
                    ...
                    <div class="form-group">
                         ...
                         <div class="col-md-6">
                            <input type="file" name="image" class="form-control @error('image') is-invalid @enderror" id="image" name="image" value="{{ old('image') }}">
                            @if ($errors->has('image'))
