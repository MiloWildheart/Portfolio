<aside
    ...
    class="fixed left-0 top-0 h-full bg-gray-600 text-white transition-width duration-300 overflow-hidden"
>

    <ul class="p-4">
        <li class="mb-3">
        <img src="{{ asset('public\images\LogoDesign-Monsterhatmedia.png') }}" class="w-8 h-8 mr-2" alt="Logo" x-show="open" x-cloak>
        </li>
        <li class="mb-1" >
